...
export default function Home() {
  return (
      <div className="flex grow justify-center bg-slate-100 dark:bg-slate-700">
        <main className="flex shadow-md flex-col m-3 container text-center rounded-sm bg-white dark:bg-slate-900 dark:text-white">
